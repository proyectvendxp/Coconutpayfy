<?php
    ...
    //=========== Variable Declreation ==========
        ...
        $district = "Sin información";
        $city = "Sin información";
        $pin_code = "100001";
        $account_no = "";
        $acount_balance = 5000;
        $aadhar_number = "1000023";
            ...
            if($option == 'view' || $option == 'edit'){
                ...
                // ==========Genrate Account Number===========
                    ...
                    if(mysqli_num_rows($sql_ac)>0){
                        ...
                        $get_ac = str_replace("MKS", "", $prives_ac);
                        $ac_incrase = $get_ac+1;
                        $get_ac_string = str_pad($ac_incrase, 12,0, STR_PAD_LEFT);

                        $ac_number = "MKS".$get_ac_string;
                    }else{
                        $ac_number = "MKS677209939100";
                    }
        ...
        if(isset($_GET["msg"]) && $_GET["msg"] != ""){
            ...
            if($msg_get == "msg"){
                $msg = "<div class='alert alert-success alert-dismissible fade show' role='alert'>
                    <h4 class='alert-heading'>Gracias a mis creadores OwO se les quiere <3</h4>
                    <strong>Todo correcto señor admin owo</strong>
            ...
            if($option == ''){
                if(mysqli_num_rows($sql_fetch)>0){
                    $msg = "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
                        <strong>Ooop!</strong> Esto ya existe, supuestamente eh!!, contacta con Alejo
                        <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                    </div>";
                }else{
    ...
    <!-- ------------Employe Form---------------- -->
        ...
        <div class="container" id="add_page">
                ...
                <?php 
                    if($option == 'view'){
                        echo "
                            ...
                            <p><span class='text-primary'>$name</span> Detalles--..</p>
                        ";
                    }else if ($option == 'edit'){
                        echo "
                        ...
                        echo "
                            ...
                            <p>Llenar detalles de usuario, y luego proceder al reconocimiento facial (PIO_FACERECOG) (LUISNET)</p>
                        ";
                    }
                ?>
            </div>
            <form method="post" action="" class="row g-3 mt-2 mb-2">
                <div class="col-xl-4">
                    <label for="inputAddress" class="form-label">Numero de cuenta</label>
                ...
                <div class="col-md-4">
                    <label for="inputAddress" class="form-label">Número de usuario</label>
                            ...
                            <?php 
                                if($option == 'view'){
                                    ...
                                    echo "
                                        ...
                                        <option value='Mujer'>Femail</option>
                                         <option value='Prefiero no decirlo'>Prefiero de decirlo</option>
                                    ";
                                }   
                            ?>
                    </select>
                ...
                <div class="col-md-6">
                    <label for="inputEmail4" class="form-label">Caracteristicas físicas</label>
                ...
                <div class="col-md-6">
                    <label for="inputAddress" class="form-label">Comentarios Adicionales</label>
                    <input <?php echo $disabled; ?> type="text" value="<?php echo $city ?>" class="form-control" id="inputAddress" name="city" required>
                </div>
                <div class="col-md-6">
                    <label for="inputAddress" class="form-label">PIN DE ÚNICO USO</label>
