        ...
        if(isset($_GET["msg"])){
            ...
            if($msg_get == "msg"){
                $msg = "<div class='alert alert-success alert-dismissible fade show' role='alert'>
                    <h4 class='alert-heading'>Hecho!!, Gracias a mis creadores @Luis9799 @Cagonzales!</h4>
                    <strong>Todo correcto OwO</strong>
    ...
    <!-- Display Customer Table -->
        ...
        <div class="container" id="display_record">
            <div class="row text-center">
                <h2>détails de nos clients </h2>
                <p>Detalles de nuestros hermosos clientes</p>
            </div>
            <div class="table-responsive mt-2">
                <table class="table table-striped table-hover table-bordered">
                    <thead>
                        <tr>
                            <th width="15%" scope="col">Número de cuenta</th>
                            <th width="15%" scope="col">Número añadido  </th>
                            <th width="10%" scope="col">Balance de cuenta</th>
                            <th width="20%" scope="col">Nombre</th>
                            <th width="10%" scope="col">Genero</th>
                            <th width="10%" scope="col">Creado</th>
                            <th width="10%" scope="col">Transacción</th>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php 
                                    ...
                                    ?></td>
                                <td>
                                    <a href="All__Transction__History.php?type=n&id=<?php echo $row['account_no']; ?>"><button class="btn btn-primary">Transacciones</button></a>
                                </td>
