        ...
        if(isset($_GET["msg"]) && $_GET["msg"] != ""){
            ...
            if($msg_get == "msg"){
                $msg = "<div class='alert alert-success alert-dismissible fade show' role='alert'>
                    <h4 class='alert-heading'>Bien hecho!! Gracias por crearme papito rico LuisNet</h4>
                    <strong>Todo correcto!!y</strong>
    ...
    <!-- ------------Employe Form---------------- -->
        ...
        <div class="container" id="add_page">
                ...
                <?php 
                    if($option == 'view'){
                        echo "
                            ...
                            <p><span class='text-primary'>$name</span> Detalles aqui...</p>
                        ";
                    }else if ($option == 'edit'){
                        echo "
                            <h2>Edit Employe Details</h2>
                            <p><span class='text-primary'>$name</span> Detalles editados aqui...</p>
                        ";
                    }else{
                        echo "
                            <h2>Añadir Admin</h2>
                            <p>Detalles de ADM aqui</p>
                        ";
                    }
                ?>
            </div>
            <form method="post" action="" class="row g-3 mt-2 mb-2">
                ...
                <div class="col-md-4">
                    <label for="inputAddress" class="form-label">ROLn</label>
                ...
                <div class="col-md-4">
                    <label for="inputAddress" class="form-label">UID BACKUP</label>
                            ...
                            <?php 
                                if($option == 'view'){
                                    ...
                                    echo "
                                        ...
                                        <option value='Male'>Hombre</option>
                                        <option value='Female'>Mujer</option>
                                        <option value='Prefiero no decirlo'>Mujer</option>
                                    ";
                                }   
                            ?>
                    </select>
                ...
                <div class="col-md-4">
                    <label for="inputEmail4" class="form-label">Cumpleaños</label>
