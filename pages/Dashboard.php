        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-xl-4">
                    <div class="card text-dark bg-light mb-3" style="max-width: 18rem;">
                        <div class="card-body text-center">
                            <h4 class="card-title text-uppercase text-primary">💖Clientes totales</h4>
                ...
                <div class="col-xl-4">
                    <div class="card text-dark bg-light mb-3" style="max-width: 18rem;">
                        <div class="card-body text-center">
                            <h4 class="card-title text-uppercase text-primary">💸Administradores</h4>
                ...
                <div class="col-xl-4">
                    <div class="card text-dark bg-light mb-3" style="max-width: 18rem;">
                        <div class="card-body text-center">
                            <h4 class="card-title text-uppercase text-primary">🥥BALANCE GLOBAL</h4>
